...
class CustomDocumentContextExtractor(BaseExtractor):
    """
    ...
    async def _agenerate_node_context(
        ...
        for attempt in range(max_retries):
            try:
                ...
                # raise exception on error if not retrying
                raise Exception("Rate limit hit: " + str(e))
                return metadata
...
#     print(CustomDocumentContextExtractor.ORIGINAL_CONTEXT_PROMPT)
